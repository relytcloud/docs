...
| `internal_server_error` | 内部服务器错误，表示处理请求时发生了 Powerdrill 端的问题，可能是临时问题、Bug 或系统故障。 |
...
| `300004` | Invalid file extension | 200 | 文件扩展名不受 Powerdrill 支持。支持的扩展名包括 **.csv**、**.tsv**、**.md**、**.mdx**、**.json**、**.txt**、**.pdf**、**.pptx**、**.ppt**、**.doc**、**.docx**、**.xls** 和 **.xlsx**。 |
